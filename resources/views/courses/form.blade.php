...
@section('content')
    <div class="pl-5 pr-5">
        ...
        >
            <!-- Si se esta tratando de editar pasa el metodo put sino va como un insert normal-->
            @if($course->id)
                @method('PUT')
            @endif
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group ml-3 mr-2">
                                <div class="col-md-6 offset-4">
                                    <input type="file"
                                           class="custom-file-input{{ $errors->has('picture') }} ? ' in invalid' : '' "
                                           id="picture"
                                           name="picture"
                                    />
                                    <label class="custom-file-label"
                                           for="picture">{{ __("Escoge una imagen para tu curso") }}</label>
                                </div>
                            </div>
