...
@push('styles')
    <link rel="stylesheet" href="{{ asset('css/pricing.css') }}"> @endpush
    ...
    <div class="container">
        <div class="pricing-table pricing-three-column row">
            <div class="plan col-sm-4 col-lg-4">
                ...
                <ul>
                    <li class="plan-feature">{{ __("Accesso a todos los cursos") }}</li>
                    <li class="plan-feature">{{ __("Accesso a todos los archivos") }}</li>
